...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <form action="/barang" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" id="nama" name="nama" placeholder="Nama Barang" required>
        </div>
        <div>
            <label for="kode">Kode Barang</label>
            <input type="text" id="kode" name="kode" placeholder="Kode Barang" required>
        </div>
        <div>
            <label for="harga">Harga Barang</label>
            <input type="number" id="harga" name="harga" placeholder="Harga Barang" required>
        </div>
        <div>
